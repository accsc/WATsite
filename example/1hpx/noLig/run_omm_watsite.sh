...
/programs/miniconda/bin//python /programs/WATsite/bin/openmm_prep.py  -i /programs/WATsite/example/noLig/prot_amber.inpcrd -t /programs/WATsite/example/noLig/prot_amber.prmtop \
-l PME -c 10.00 --shake \
...
/programs/miniconda/bin//python /programs/WATsite/bin/openmm_md.py  -i /programs/WATsite/example/noLig/prot_amber.inpcrd -t /programs/WATsite/example/noLig/prot_amber.prmtop \
